pub use multiagent_core::worktree::{
...
pub fn create_thread_worktree(
    ...
    multiagent_core::worktree::create_thread_worktree(
...
pub fn preview_worktree_merge(worktree_path: &str) -> Result<WorktreeMergePreview, String> {
    multiagent_core::worktree::preview_worktree_merge(worktree_path)
}
...
pub fn apply_worktree_merge(
    ...
    multiagent_core::worktree::apply_worktree_merge(worktree_path, live_workspace_path)
}

pub fn stop_worktree_checkout(worktree_path: &str) -> Result<(), String> {
    multiagent_core::worktree::stop_worktree_checkout(
        worktree_path,
        &crate::data::default_app_data_dir(),
    )
}
